...
class conexion{
    ...
    public function __construct(){ #$servidor,$usuario,$pass,$dbname
        try{
            #$this->conexion = new PDO("mysql:host=$servidor;dbname=propiedades",$usuario,$pass);
            $this->conexion = new PDO("mysql:host=$this->servidor;dbname=propiedades",$this->usuario,$this->pass);
